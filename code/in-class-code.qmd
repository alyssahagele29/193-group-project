...
gl_stacked_native <- gl_all_interest |> 
  ...
  summarize(sum_pc_sum = sum(sum_pc)) |> 
  ungroup() |> 
  mutate(native)
...
vis1 <- ggplot(data = gl_all_pc,
  ...
  scale_color_manual(values = c(
    "Stipa_pulchra" = "royalblue",
    "Distichlis_spicata" = "lightblue3",
    "Deinandra_fasciculata" = "turquoise3",
    "Erigeron_canadensis" = "lightblue",
    "Symphyotrichum_subulatum" = "turquoise",
    "Festuca_perennis" = "red3",
    "Polypogon_monspeliensis" = "darkred",
    "Bromus_hordeaceus" = "firebrick",
    "Festuca_myuros" = "red",
    "Medicago_polymorpha" = "tomato"
  )) +
  theme_bw() +
  facet_wrap(~ native)
