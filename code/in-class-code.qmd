...
```{r}
#| label: alyssa vis-3 species richness native barplot
...
### density plots 
```{r}
# native richness density plot
native_richness_plot_density <- native_species_rich |>
  ...
  # add labels
  labs(
    title = "Distribution of Native Species Richness",
